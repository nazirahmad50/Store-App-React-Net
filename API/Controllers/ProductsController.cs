...
namespace API.Controllers
{
    public class ProductsController : BaseApiController
    {
        ...
        public async Task<ActionResult<PagedList<Product>>> GetProducts([FromQuery] ProductParams productParams)
        {
            ...
            Response.AddPaginationHeaer(products.MetaData);
        ...
        [Authorize(Roles = "Admin")]
        [HttpPut]
        public async Task<ActionResult<Product>> UpateProduct([FromForm]UpdateProductDto productDto)
        {
            ...
            return BadRequest(new ProblemDetails { Title = "Problem updaitng product" });
        }
